...
namespace OR{
enum class IT4_RMP_t : uint32_t {
    IT4_RMP_0 = 0, // field has value 0x0
IT4_RMP_1 = 1, // field has value 0x1
IT4_RMP_2 = 2, // field has value 0x2
IT4_RMP_3 = 3, // field has value 0x3
...
class OR : public ReadableWritable<address> {
   public:
    ...
    return reinterpret_cast<IT4_RMP_t>(tmp);
}
void IT4_RMP(IT4_RMP_t v){
   uint32_t tmp = v << 6;
